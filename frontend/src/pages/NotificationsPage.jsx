...
export default function NotificationsPage() {
  ...
  const load = async () => { const { data } = await notificationsApi.getNotifications(); setNotifications(data.notifications || []); };
